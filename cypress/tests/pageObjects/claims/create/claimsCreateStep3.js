...
class ClaimsCreateStep3 extends BaseForm {
  ...
  constructor() {
    ...
    this.#OGPOInsuranceEventTypeDropdown = new Button(new XPATH('//label[text() = "Тип Страхового случая *"]/following-sibling::div/descendant::div[@class = "multiselect__select"]'), 'OGPO insurance event type dropdown');
    this.#OGPOInsuranceEventTypeDropdownChosenElement = new Button(new XPATH('//label[text() = "Тип Страхового случая *"]/following-sibling::div/descendant::div[@class = "multiselect__select"]/following::span[@class = "multiselect__single"]'), 'OGPO insurance event type dropdown chosen element');
    this.#OGPOInsuranceEventTypeDropdownElements = new Button(new XPATH('//label[text() = "Тип Страхового случая *"]/following-sibling::div/descendant::div[@class = "multiselect__select"]/following-sibling::div/ul/li[@class = "multiselect__element"]'), 'OGPO insurance event type dropdown elements');
    this.#insuredObjectDropdown = new Button(new XPATH('(//label[@for = "vehicle_esbd_id"]/following-sibling::div/descendant::div[@class = "multiselect__select"])[last()]'), 'last victim object risks dropdown');
    this.#insuredObjectDropdownElements = new Button(new XPATH('(//label[@for = "vehicle_esbd_id"]/following-sibling::div/descendant::div[@class = "multiselect__select"])[last()]/following-sibling::div/ul/li[@class = "multiselect__element"]'), 'last victim object risks dropdown elements');
    this.#victimObjectFormLabel = new Label(new XPATH('//div[contains(@class,"mb-flex-direction-column")]/child::h6'), 'victim object form label');
    ...
    this.#lastVictimObjectRisksDropdown = new Button(new XPATH('(//span[text() = "Тип риска договоров страхования *"]/following-sibling::div/descendant::div[@class = "multiselect__select"])[last()]'), 'last victim object risks dropdown');
    this.#lastVictimObjectRisksDropdownChosenElement = new Button(new XPATH('(//span[text() = "Тип риска договоров страхования *"]/following-sibling::div/descendant::div[@class = "multiselect__select"])[last()]/following::span[@class = "multiselect__single"]'), 'last victim object risks dropdown chosen element');
    this.#lastVictimObjectRisksDropdownElements = new Button(new XPATH('(//span[text() = "Тип риска договоров страхования *"]/following-sibling::div/descendant::div[@class = "multiselect__select"])[last()]/following-sibling::div/ul/li[@class = "multiselect__element"]'), 'last victim object risks dropdown elements');
    ...
    this.#lastVictimObjectTypeDropdown = new Button(new XPATH('(//span[text() = "Вид пострадавшего объекта *"]/following-sibling::div/descendant::div[@class = "multiselect__select"])[last()]'), 'last victim object type dropdown');
    this.#lastVictimObjectTypeDropdownElements = new Button(new XPATH('(//span[text() = "Вид пострадавшего объекта *"]/following-sibling::div/descendant::div[@class = "multiselect__select"])[last()]/following-sibling::div/ul/li[@class = "multiselect__element"]'), 'last victim object type dropdown elements');
    ...
    this.#victimOtherTypeDropdown = new Button(new XPATH('//span[text() = "Иной тип пострадавшего объекта *"]/following-sibling::div/descendant::div[@class = "multiselect__select"]'), 'victim other type dropdown');
    this.#victimOtherTypeDropdownChosenElement = new Button(new XPATH('//span[text() = "Иной тип пострадавшего объекта *"]/following-sibling::div/descendant::div[@class = "multiselect__select"]/following::span[@class = "multiselect__single"]'), 'victim other type dropdown chosen element');
    this.#victimOtherTypeDropdownElements = new Button(new XPATH('//span[text() = "Иной тип пострадавшего объекта *"]/following-sibling::div/descendant::div[@class = "multiselect__select"]/following-sibling::div/ul/li[@class = "multiselect__element"]'), 'victim other type dropdown elements');
    ...
    switch (type) {
      case 'vehicle':
        this.#lastVictimObjectTypeDropdownElements
          .chooseElementFromDropdown(JSONLoader.testData.OGPOVictimObjectType.vehicle);
        break;
      case 'client':
        this.#lastVictimObjectTypeDropdownElements
          .chooseElementFromDropdown(JSONLoader.testData.OGPOVictimObjectType.client);
        break;
      case 'other':
        this.#lastVictimObjectTypeDropdownElements
          .chooseElementFromDropdown(JSONLoader.testData.OGPOVictimObjectType.other);
        break;
      default:
...
module.exports = new ClaimsCreateStep3();
